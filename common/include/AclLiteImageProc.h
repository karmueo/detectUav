...
class AclLiteImageProc
{
  public:
     ...
     * others: Crop failed
     */
    AclLiteError Crop(ImageData &dest,
                      ImageData &src,
                      uint32_t   ltHorz,
                      uint32_t   ltVert,
                      uint32_t   rbHorz,
     ...
     */
    AclLiteError CropPaste(ImageData &dest,
                           ImageData &src,
                           uint32_t   width,
                           uint32_t   height,
                           uint32_t   ltHorz,
     ...
     */
    AclLiteError ProportionPaste(ImageData &dest,
                                 ImageData &src,
                                 uint32_t   ltHorz,
                                 uint32_t   ltVert,
                                 uint32_t   rbHorz,
     ...
     */
    AclLiteError ProportionPasteCenter(ImageData &dest,
                                       ImageData &src,
                                       uint32_t   width,
                                       uint32_t   height);
