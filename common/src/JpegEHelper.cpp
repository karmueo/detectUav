...
JpegEHelper::JpegEHelper(aclrtStream        &stream,
                         acldvppChannelDesc *dvppChannelDesc)
    : stream_(stream), encodeOutBufferDev_(nullptr), jpegeConfig_(nullptr),
      encodeInputDesc_(nullptr), dvppChannelDesc_(dvppChannelDesc),
...
AclLiteError JpegEHelper::InitJpegEResource(ImageData &inputImage)
{
    ...
    acldvppJpegPredictEncSize(
        encodeInputDesc_, jpegeConfig_, &encodeOutBufferSize_);
...
AclLiteError JpegEHelper::Process(ImageData &destJpegImage,
                                  ImageData &srcYuvImage)
{
